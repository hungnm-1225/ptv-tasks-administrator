...
import { UserCheck, CheckCircle2, Search, Loader2, Zap, Check, Sparkles } from 'lucide-react';
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    <select
                                        ...
                                        className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800 px-3 py-2 text-xs font-mono text-slate-900 dark:text-white cursor-pointer"
                                    >
