...
-- Atomic, idempotent revision allocator.  Keep this in the canonical schema
-- as well as its timestamped migration so fresh environments match runtime.
...
-- Atomic approval: proposal freeze, workflow state transition and audit event
