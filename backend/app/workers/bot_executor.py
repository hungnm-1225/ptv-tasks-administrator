...
async def execute_approved_bot_task(
    ...
    try:
        ...
        if bot_type == "workspace_rpa":
            ...
            # 🎯 Chuyển thẳng toàn bộ tác vụ Workspace (Update User, Duyệt Order, Duyệt Contract, E2E) sang Orchestrator
            logger.info(f"🏢 {task_tag} Điều phối tác vụ Workspace qua Orchestrator ({action})...")
